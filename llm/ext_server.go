...
#cgo linux LDFLAGS: -L/opt/rocm/lib
#cgo linux LDFLAGS: ${SRCDIR}/llama.cpp/gguf/build/rocm/examples/server/libext_server.a
#cgo linux LDFLAGS: ${SRCDIR}/llama.cpp/gguf/build/rocm/common/libcommon.a
#cgo linux LDFLAGS: ${SRCDIR}/llama.cpp/gguf/build/rocm/libllama.a
#cgo linux LDFLAGS: ${SRCDIR}/llama.cpp/gguf/build/rocm/libggml_static.a
